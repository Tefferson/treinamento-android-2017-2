...
public class TrooperRepository {
    ...
    tryGettingFromSharedPreferences(SharedPreferences sharedPreferences) {
        ...
        if (util.hasValue(Constants.TROOPER_LIST)) {
            ...
            ArrayList<Trooper> troopers = gson
                    .fromJson(json, new TypeToken<ArrayList<Trooper>>() {
                    }.getType());
        }
    ...
    public static void saveToSharedPreferences(SharedPreferences sharedPreferences, ArrayList<Trooper> troopers) {
